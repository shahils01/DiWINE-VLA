...
from .libero_robomimic import LiberoRoboMimicHandler
from .lerobotv21 import LeRobotV21Handler
from .lerobot_so101 import SO101LeRobotHandler
...
_REGISTRY: Dict[str, Type[DomainHandler]] = {
    ...
    "libero_rmb": LiberoRoboMimicHandler,
    "VLABench": VLABenchHandler,
    "robotwin2_abs_ee": RobotWin2Handler,
    "robotwin2_clean": RobotWin2Handler,
    "robotwin2-aloha-agilex": RobotWin2Handler,
    "robotwin2-arx-x5": RobotWin2Handler,
    "robotwin2-franka": RobotWin2Handler,
    "robotwin2-ur5": RobotWin2Handler,
